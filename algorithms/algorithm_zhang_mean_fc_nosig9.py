...
class ZhangNet(nn.Module):
    ...
    def forward(self, X):
        ...
        reweight_out_2 = X * channel_weights
        output2 = self.classnet2(reweight_out_2)

        return channel_weights, sparse_weights, output, output2


class Algorithm_zhang_mean_fc_nosig9(Algorithm):
    ...
    def get_selected_indices(self):
        ...
        for epoch in range(self.total_epoch):
            ...
            for batch_idx, (X, y) in enumerate(dataloader):
                optimizer.zero_grad()
                channel_weights, sparse_weights, y_hat, yh2 = self.zhangnet(X)
